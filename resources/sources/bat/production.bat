...
--compiler_flags="--define=URI_MODULES='http://static.travelcloud.com.co/static/technocloud/%1/flights/js/'" ^
...
--compiler_flags="--define=URL_CANCEL='http://www.travelcloud.com.co/site/cancel.ashx'" ^
--compiler_flags="--define=goog.DEBUG=false" ^
--compiler_flags="--compilation_level=ADVANCED" ^
--compiler_flags="--compilation_level=ADVANCED" ^
--compiler_flags="--module_output_path_prefix='..\\www\\%1\\js\\technocloud_'" ^
