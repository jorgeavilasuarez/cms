...
--compiler_flags="--define=URL_SEARCH='http://localhost:49815/site/search.ashx'" ^
--compiler_flags="--define=URL_AVAILABILITY='http://localhost:49815/site/availability.ashx'" ^
--compiler_flags="--define=URL_BOOKING='http://localhost:49815/site/booking.ashx'" ^
