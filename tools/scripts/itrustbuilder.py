...
def main():
  ...
  for input_path in inputs:
    ...
    if not js_input:
      ...
      sys.exit(1)
    #input_namespaces= input_namespaces + js_input.provides

  input_namespaces= input_namespaces + options.namespaces
  ...
  if output_mode == 'list':            
    ...
    for js_source in deps:
      cont=cont+1
      out.writelines(str(cont) + '  ' + js_source.GetPath()+'\n' )      
